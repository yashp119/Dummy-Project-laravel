									  ...
									  <div class="panel-heading lg text-center">
										...
										<div class="the-box full no-border property-card">
											<div id="property-slide-8" class="owl-carousel">
											  <div class="item full"><img src="assets/img/photo/small/img.jpg" alt="Image"></div>
											  <div class="item full"><img src="assets/img/photo/small/img.jpg" alt="Image"></div>
											  <div class="item full"><img src="assets/img/photo/small/img.jpg" alt="Image"></div>
											</div>
								...
								<div class="col-sm-6 col-md-6 col-lg-12">
									...
									<div class="the-box bg-warning no-border full">
										<div id="tiles-slide-2" class="owl-carousel tiles-carousel">
										  <div class="item full">
											<img src="assets/img/avatar/avatar.jpg" class="avatar img-circle has-white-shadow" alt="avatar">
											<div class="des">
											...
											<img src="assets/img/photo/medium/img.jpg" alt="Image">
										  </div><!-- /.item full -->
										  <div class="item full">
											<img src="assets/img/avatar/avatar.jpg" class="avatar img-circle has-white-shadow" alt="avatar">
											<div class="des">
										...
										<div id="tiles-slide-3" class="owl-carousel tiles-carousel-color">
										  <div class="item full">
											<div class="avatar-wrap">
												<div class="media">
												  <a class="pull-left" href="#fakelink">
													<img src="assets/img/avatar/avatar.jpg" class="avatar img-circle has-white-shadow media-object" alt="avatar">
												  </a>
												  <div class="media-body">
