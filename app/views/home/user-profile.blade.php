					...
					<ul class="simple-post-list">
						<li>
							<div class="post-image">
								<div class="img-thumbnail">
									<a href="#">
										<img src="{{asset('assets/images/post-thumb-1.jpg')}}" alt="">
									</a>
								</div>
							</div>
							<div class="post-info">
						...
						<li>
							<div class="post-image">
								<div class="img-thumbnail">
									<a href="#">
										<img src="{{asset('assets/images/post-thumb-2.jpg')}}" alt="">
									</a>
								</div>
							</div>
							<div class="post-info">
						...
						<li>
							<div class="post-image">
								<div class="img-thumbnail">
									<a href="#">
										<img src="{{asset('assets/images/post-thumb-3.jpg')}}" alt="">
									</a>
								</div>
							</div>
							<div class="post-info">
			...
			<div class="tabs">
				...
				<div class="tab-content">
					...
					<div id="password" class="tab-pane">					
						{{Form::open(array('url'=>'users/changepassword','role'=>'form', 'class'=>'form-horizontal','id'=>'changepassword_form'))}}
						    ...
						    <div class="form-group mb-lg">
								<label class="col-md-3 control-label" for="newpassword_confirmation">Repeat New Password</label>
								<div class="col-md-8">
