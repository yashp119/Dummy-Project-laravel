		...
		<section class="body">
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
					<!-- Begin static table -->
                    <h4 class="small-title"> <strong> SalesForce Member Info </strong></h4>


					<div class="form-group">
						<label class="col-md-2 control-label">MedAssets ID:</label>
						<div class="col-md-2">
							<div class="input-group input-search">
								<input type="text" class="form-control" name="q" id="q" placeholder="Search..." value="{{$id or ''}}">
								<span class="input-group-btn">
									<button class="btn btn-default" type="submit"><i class="fa fa-search"></i></button>
								</span>
							</div>
					...
					<h5 class="small-title"> <strong> {{$name or ''}}</strong></h5>
                    <div class="the-box full no-border">
                        <div class="table-responsive">
                            <table class="table table-th-block table-hover">
                                <tbody>
                                <tr>
                                	<td class="col-md-3" align="right">Member Name	</td><td class="col-md-3">{{$Name or ''}}	</td>
                                	<td class="col-md-3" align="right">Phone		</td><td class="col-md-3">{{$Phone or ''}}	</td>
                                </tr>
                                <tr>
                                	<td align="right">Member Type		 </td><td>{{$Type or ''}} 			</td>
                                	<td align="right">DEA 				 </td><td>{{$DEA__c or ''}}			</td>
                                </tr>
                                <tr>
                                	<td align="right">MedAssets ID 		</td><td>{{$MedAssets_ID__c or ''}}	</td>
                                	<td align="right">HIN 				</td><td>			</td>
                                </tr>
                                <tr>
                                	<td align="right">Enrollment Date	</td><td>			</td>
                                	<td align="right">Billing Address	</td><td>54 Marvin LN,<br>Piscataway,NJ,08854			</td>
                                </tr>
                                <tr>
                                	<td align="right">Distributor Rep	</td><td>			</td>
                                	<td align="right">Website			</td><td>			</td>
                                </tr>
                                <tr>
                                	<td align="right">Created By		</td><td>			</td>
                                	<td align="right">Last Modified By	</td><td>			</td>
                                </tr>
                                </tbody>
                            </table>
